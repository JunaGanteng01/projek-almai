...
<div class="w-full pb-12">
    ...
    <div class="mb-6 flex flex-col md:flex-row justify-between md:items-center gap-4 px-6 md:px-0">
        <h1 class="text-xl md:text-2xl font-black text-white uppercase tracking-tight">Konsultasi</h1>
    </div>
    ...
    <div class="bg-[#111] border border-white/10 rounded-2xl p-4 shadow-xl mb-6">
        <form method="GET" action="<?= base_url('laporan-kegiatan/konsultasi') ?>" class="flex flex-col md:flex-row gap-4">
            <div class="flex-1">
            ...
            <div class="flex gap-2">
                ...
                <?php if(!empty($search)): ?>
                    <a href="<?= base_url('laporan-kegiatan/konsultasi') ?>" class="bg-red-500/20 hover:bg-red-500/30 text-red-500 px-4 py-2 rounded-xl text-xs font-bold uppercase tracking-widest transition flex items-center justify-center">
            ...
            <table class="w-full text-left border-collapse min-w-[1000px]">
                <thead>
                    <tr class="bg-black/50 text-accent text-center font-bold text-[10px] uppercase tracking-wider">
                        ...
                        <th class="p-3 border-b border-r border-white/10">Nama Klien</th>
