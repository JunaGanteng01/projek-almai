                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($row['is_recurring'])): 
                            ...
                            echo implode(', ', $dArr) . " $mIndo $tahun<br><small style='font-size:8px;'>" . htmlspecialchars($row['recurring_time']) . "</small>";
                        else:
                            echo (!empty($row['tanggal']) && strpos($row['tanggal'], '0000-00-00') === false) ? date('d-m-Y', strtotime($row['tanggal'])) : '-';
                        endif; ?>
                    </td>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= htmlspecialchars($ea['judul'] ?? '-') ?></td>
                <td><?= htmlspecialchars($ea['topik'] ?? '-') ?></td>
