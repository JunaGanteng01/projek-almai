...
<div class="mb-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
    ...
    <div class="flex items-center gap-2">
        <a href="<?= base_url('laporan-kegiatan/laporan-bank-indonesia/export-excel') ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all shadow-lg hover:shadow-green-600/20 flex items-center gap-2">
            <i class="fas fa-file-excel"></i>
            Export Excel
        </a>
        <a href="<?= base_url('laporan-kegiatan/laporan-bank-indonesia/export') ?>" target="_blank" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-xl text-sm font-semibold transition-all shadow-lg hover:shadow-red-600/20 flex items-center gap-2">
