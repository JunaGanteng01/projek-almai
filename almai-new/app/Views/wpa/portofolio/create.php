...
<div class="w-full space-y-6">
    <div class="flex items-center gap-4">
        <a href="<?= base_url('wpa/dashboard/portofolio') ?>" class="p-2 hover:bg-white/10 rounded-lg transition text-gray-400 hover:text-white">
    ...
    <form action="<?= base_url('wpa/dashboard/portofolio/store') ?>" method="POST" class="space-y-6">
        <?= csrf_field() ?>
        ...
        <div class="bg-[#111] border border-white/10 rounded-xl p-8 md:p-10 shadow-xl">
            ...
            <div class="pt-10 flex flex-col md:flex-row gap-4">
                ...
                <a href="<?= base_url('wpa/dashboard/portofolio') ?>" class="px-8 py-4 bg-white/5 hover:bg-white/10 text-gray-400 hover:text-white rounded-xl transition-all text-center font-bold">
                    BATAL
                </a>
            </div>
        </div>
