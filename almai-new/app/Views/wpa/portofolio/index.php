...
<div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-6 bg-[#111] p-6 rounded-xl border border-white/10">
    ...
    <a href="<?= base_url('wpa/dashboard/portofolio/create') ?>" 
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
    <?php if(!isset($accounts) || empty($accounts)): ?>
        <div class="lg:col-span-3 py-20 bg-[#111] border border-dashed border-white/10 rounded-xl flex flex-col items-center justify-center text-center">
            ...
            <a href="<?= base_url('wpa/dashboard/portofolio/create') ?>" class="bg-accent text-black font-black px-10 py-4 rounded-2xl shadow-xl hover:scale-105 transition-all">
            ...
            <div class="bg-[#111] rounded-xl border border-white/5 p-8 transition-all group relative overflow-hidden">
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="<?= base_url('wpa/dashboard/portofolio/delete/' . $acc['id']) ?>" onclick="return confirm('Hapus portofolio ini?')" class="w-12 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-white rounded-xl transition flex items-center justify-center border border-red-500/10">
