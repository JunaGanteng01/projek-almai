    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 md:ml-64 pt-14 md:pt-0">
            ...
            <section class="p-4 md:p-8">
                ...
                <?php if ($artikel['verification_status'] === 'rejected'): ?>
                <div class="bg-red-500/20 border border-red-500/30 text-red-400 px-4 py-3 rounded-xl mb-4">
                    <p class="font-bold"><i class="fas fa-exclamation-circle mr-2"></i>Artikel Ditolak</p>
                    <p class="text-sm mt-1">Alasan: <?= esc($artikel['rejection_reason']) ?></p>
                    <p class="text-xs mt-2 text-gray-400">Perbaiki artikel dan kirim ulang untuk verifikasi.</p>
                </div>
                <?php endif; ?>

                <form action="<?= base_url('wpa/dashboard/artikel/update/' . $artikel['id']) ?>" method="post" class="max-w-4xl">
                    <?= csrf_field() ?>
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-[#111] border border-white/10 rounded-2xl overflow-hidden">
                                ...
                                <div class="p-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="px-2 py-1 bg-yellow-500/20 text-yellow-500 rounded-full text-xs">Pending</span>
                            ...
                            <div class="bg-[#111] border border-white/10 rounded-2xl p-6">
                                ...
                                <div class="space-y-4">
                                    <div>
                                        ...
                                        <input type="number" name="poin_price" required value="<?= old('poin_price', $artikel['poin_price']) ?>" min="0"
                                            class="w-full bg-black border border-white/20 rounded-xl px-4 py-3 focus:border-accent focus:outline-none" 
                                            placeholder="100">
                                    </div>
                                    <div class="flex items-center gap-3">
                                        <input type="checkbox" name="is_free" id="is_free" value="1" <?= old('is_free', $artikel['is_free']) ? 'checked' : '' ?>
                            ...
                            <div class="bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-4">
                                <p class="text-sm text-yellow-500"><i class="fas fa-info-circle mr-2"></i>Setelah update, artikel akan dikirim ulang untuk verifikasi.</p>
                            </div>
                            <?php endif; ?>
