...
<div class="space-y-6">
    ...
    <form action="<?= base_url('wpa/dashboard/layanan/update/' . $layananType . '/' . $layanan['id']) ?>" method="POST" enctype="multipart/form-data" id="wizardForm">
        <?= csrf_field() ?>
        ...
        <div id="step-content-1" class="space-y-6">
            ...
            <?php if (in_array($layananType, ['webinar', 'workshop', 'live_trade'])): ?>
            <div class="bg-[#111] border border-white/10 rounded-xl p-6">
