...
<div class="mb-6 flex flex-col md:flex-row md:items-center justify-between gap-4">
    ...
    <div class="overflow-x-auto pb-2 -mx-4 px-4 md:mx-0 md:px-0 flex-1">
        <div class="flex gap-2 min-w-max">
            ...
            <a href="<?= base_url('wpa/dashboard/daftar-layanan') . ($searchQuery ? '?search=' . urlencode($searchQuery) : '') ?>"
            ...
            <a href="<?= base_url('wpa/dashboard/daftar-layanan?category=Advokasi' . $searchParam) ?>"
            ...
            <a href="<?= base_url('wpa/dashboard/daftar-layanan?category=Expert+Advisor' . $searchParam) ?>"
            ...
            <a href="<?= base_url('wpa/dashboard/daftar-layanan?category=Ultimate' . $searchParam) ?>"
    ...
    <div class="w-full md:w-auto">
        <form action="<?= base_url('wpa/dashboard/daftar-layanan') ?>" method="get" class="relative" id="searchForm">
...
<?php if ($currentCategory && $currentCategory !== 'all' && !empty($subcategories)): ?>
    <div class="mb-6 flex flex-wrap gap-2">
        <a href="<?= base_url('wpa/dashboard/daftar-layanan?category=' . urlencode($currentCategory) . $searchParam) ?>"
        ...
        <?php foreach ($subcategories as $sub): ?>
            <a href="<?= base_url('wpa/dashboard/daftar-layanan?category=' . urlencode($currentCategory) . '&subcategory=' . urlencode($sub) . $searchParam) ?>"
            ...
            <div class="group bg-[#111] border border-white/10 rounded-2xl overflow-hidden hover:border-accent/50 transition-all duration-300">
                ...
                <div class="p-4">
                    ...
                    <div class="flex items-center gap-2 mb-3">
                        <img src="<?= esc($item['wpa_photo']) ?>" alt="" class="w-6 h-6 rounded-full object-cover">
                        <span class="text-xs text-gray-400"><?= esc($item['wpa_name']) ?></span>
                    </div>
