...
<div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <a href="<?= base_url('wpa/dashboard/advokasi') ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 border border-white/10 text-white font-bold rounded-xl hover:bg-white/10 transition text-sm">
        ...
        <div id="canva-container" class="absolute inset-0 w-full h-full bg-black flex items-center justify-center">
            <?php if (!empty($activeLink)): ?>
                ...
                <?php
                    ...
                    // SECURITY: Validasi URL langsung — hanya izinkan https:// dari domain embed yang dikenal
