...
<div class="mb-6">
    <nav class="flex items-center gap-2 text-sm text-gray-400">
        <a href="<?= base_url('wpa/dashboard') ?>" class="hover:text-white transition">Dashboard</a>
        <i class="fas fa-chevron-right text-[10px]"></i>
        <?php if (($activeMenu ?? '') === 'daftar-wpa'): ?>
            <a href="<?= base_url('wpa/dashboard/daftar-wpa') ?>" class="hover:text-white transition">Daftar WPA</a>
        <?php else: ?>
            <a href="<?= base_url('wpa/dashboard/daftar-layanan') ?>" class="hover:text-white transition">Layanan</a>
        <?php endif; ?>
        <i class="fas fa-chevron-right text-[10px]"></i>
