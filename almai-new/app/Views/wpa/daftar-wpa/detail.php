...
<section class="wpa-profile-content relative pt-6 md:pt-12 pb-12 overflow-hidden">
    ...
    <div class="px-4 md:px-8 relative z-10">
        ...
        <div class="mb-8 flex items-center gap-4">
            <a href="<?= base_url('wpa/dashboard/daftar-wpa') ?>" class="w-10 h-10 bg-black/40 border border-white/10 rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition shadow-lg">
                <i class="fas fa-arrow-left"></i>
            </a>
            <div>
                <nav class="flex items-center gap-2 text-[10px] text-gray-500 uppercase tracking-widest font-bold">
                    <a href="<?= base_url('wpa/dashboard') ?>" class="hover:text-accent">Dashboard</a>
                    <i class="fas fa-chevron-right text-[8px]"></i>
                    <a href="<?= base_url('wpa/dashboard/daftar-wpa') ?>" class="hover:text-accent">Daftar WPA</a>
                    <i class="fas fa-chevron-right text-[8px]"></i>
                                    ...
                                    <?php if (!empty($instagramData)): ?>
                                        ...
                                        <div class="bg-[#1a1a1a] border border-white/10 rounded-xl overflow-hidden hover:border-pink-500/50 transition-all duration-300">
                                            ...
                                            <div class="grid grid-cols-2 gap-4 p-4 text-center">
                                                <div>
                                                    <div class="font-bold text-white text-lg"><?= esc($igService->formatFollowerCount($igFollowers)) ?></div>
                                                    <div class="text-xs text-gray-500">Followers</div>
                                                </div>
                                                <div class="border-l border-white/10">
                                                    <div class="font-bold text-white text-lg"><?= esc($igService->formatFollowerCount($igFollowing)) ?></div>
