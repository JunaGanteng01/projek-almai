...
<div class="min-h-screen flex flex-col bg-black">
    ...
    <div class="sticky top-0 z-40 bg-black/95 backdrop-blur-lg border-b border-white/10 px-4 py-4">
        <div class="flex items-center gap-4 max-w-lg mx-auto w-full">
            <a href="<?= base_url('wpa/dashboard/withdraw') ?>" class="text-white hover:text-accent transition">
                <i class="fas fa-arrow-left text-xl"></i>
            </a>
            <h1 class="text-lg font-bold">Verifikasi Identitas WPA</h1>
        </div>
    </div>

    <!-- Main Content -->
    <div class="flex-1 overflow-y-auto pb-24">
        <form id="kycForm" action="<?= base_url('wpa/dashboard/kyc/submit') ?>" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto w-full px-4 py-6">
            <?= csrf_field() ?>
...
<script>
    ...
    // Docs Logic (Identical to user/kyc.php)
    const docs = {
