            ...
            <table class="w-full text-left border-collapse min-w-[800px]">
                    ...
                    <tbody class="divide-y divide-white/5">
                        ...
                        <tr class="hover:bg-white/[0.02] text-center">
                            ...
                            <td class="p-4 border-r border-white/5 text-left text-gray-300"><?= esc($ea['nama_layanan'] ?? '-') ?></td>
                            <td class="p-4 border-r border-white/5 text-left text-gray-300 max-w-xs break-words"><?= esc($ea['penjelasan_layanan'] ?? '-') ?></td>
