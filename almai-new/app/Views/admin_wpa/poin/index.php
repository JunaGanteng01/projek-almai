...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="md:col-span-1">
        <div class="bg-[#111] border border-white/10 rounded-2xl p-6 h-full flex flex-row md:flex-col items-center justify-between md:justify-center gap-4 text-center">
            ...
            <a href="<?= base_url('admin-admin-wpa/poin/buy') ?>" class="bg-accent hover:bg-white text-black font-black text-[10px] md:text-xs uppercase tracking-widest px-6 md:w-full py-3 md:py-4 rounded-xl transition shadow-xl shadow-green-900/20 active:scale-95">
                Beli Point
            </a>
        </div>
    </div>
