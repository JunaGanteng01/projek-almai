...
<head>
    ...
    <title><?= esc($title ?? 'Admin WPA Login - Almai') ?></title>
    ...
    <div class="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div class="w-full max-w-md">
            ...
            <div class="bg-[#111] border border-white/10 rounded-2xl p-8">
                <h2 class="text-2xl font-bold mb-2">Login Admin WPA</h2>
                <p class="text-gray-500 text-sm mb-6">Kelola banyak WPA dalam satu dashboard</p>

                <form action="<?= base_url('admin-wpa/login') ?>" method="post" class="space-y-4">
                    <?= csrf_field() ?>
                    <div>
                    ...
                    <button type="submit" class="w-full py-4 bg-accent text-black font-bold rounded-xl hover:bg-white transition shadow-[0_0_30px_rgba(51,232,24,0.3)]">
                        <i class="fas fa-sign-in-alt mr-2"></i> Login Admin WPA
                    </button>
                </form>
