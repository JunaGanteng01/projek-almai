...
<div class="space-y-6">
    ...
    <form action="<?= base_url('admin-wpa/layanan/store') ?>" method="POST" enctype="multipart/form-data" id="wizardForm">
        <?= csrf_field() ?>
        ...
        editor.plugins.get('FileRepository').createUploadAdapter = (loader) => {
            return {
                upload: () => loader.file.then(file => new Promise((resolve, reject) => {
                    ...
                    fetch('<?= base_url('admin-wpa/layanan/upload-image') ?>', { method: 'POST', body: data })
                        .then(res => res.json())
