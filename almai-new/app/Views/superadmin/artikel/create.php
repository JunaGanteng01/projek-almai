...
<head>
    ...
    <title><?= esc($title ?? 'Tambah Artikel - Admin Dashboard') ?></title>
...
<body class="antialiased">
    <div class="flex min-h-screen">
        ...
        <div class="md:hidden fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a] border-b border-white/10 px-4 py-3 flex items-center gap-3">
            ...
            <span class="font-bold">Tambah Artikel</span>
        </div>
        ...
        <main class="flex-1 md:ml-64 pt-14 md:pt-0">
            <header class="bg-[#0a0a0a] border-b border-white/10 px-4 md:px-8 py-4 flex items-center gap-4 sticky top-14 md:top-0 z-10">
                ...
                <div>
                    <h1 class="text-lg md:text-xl font-bold">Tambah Artikel Baru</h1>
                    <p class="text-xs md:text-sm text-gray-500 hidden md:block">Buat konten edukasi untuk user</p>
                </div>
            </header>
            ...
            <section class="p-4 md:p-8">
                ...
                <form action="<?= base_url('superadmin/artikel/store') ?>" method="post" class="max-w-4xl">
                    <?= csrf_field() ?>
