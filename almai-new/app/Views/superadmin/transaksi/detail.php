...
<div class="mb-6">
    <a href="<?= base_url('superadmin/transaksi') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-accent transition">
    ...
    <div class="space-y-4">
        ...
        <?php if ($canWrite ?? false): ?>
            <div class="bg-[#111] border border-white/10 rounded-2xl p-6">
                ...
                <form action="<?= base_url('superadmin/transaksi/update-status/' . $transaksi['id']) ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="space-y-2 pb-4 border-b border-white/5 last:border-0 last:pb-0">
                        <div class="flex items-center justify-between group">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <form action="<?= base_url('superadmin/transaksi/resend-email/' . $transaksi['id']) ?>" method="post" class="inline">
                                    <?= csrf_field() ?>
            ...
            <div class="bg-[#111] border border-white/10 rounded-2xl p-6">
                ...
                <div class="space-y-2">
                    <?php if ($transaksi['user_id']): ?>
                        <a href="<?= base_url('superadmin/users/view/' . $transaksi['user_id']) ?>" class="flex items-center gap-3 p-3 bg-black/50 rounded-xl hover:bg-white/5 transition">
                            <i class="fas fa-user text-blue-400"></i>
                            <span class="text-sm">Lihat Profil User</span>
                        </a>
                    <?php endif; ?>
                    <?php if ($canWrite ?? false): ?>
                        <form action="<?= base_url('superadmin/transaksi/delete/' . $transaksi['id']) ?>" method="post" onsubmit="return confirm('Hapus transaksi ini?')">
                            <?= csrf_field() ?>
