...
<div class="mb-6">
    <a href="<?= base_url('superadmin/faq') ?>" class="inline-flex items-center text-gray-400 hover:text-accent transition mb-4">
        <i class="fas fa-arrow-left mr-2 text-sm"></i> Kembali ke Daftar
    </a>
    <h1 class="text-2xl font-bold">Tambah FAQ Baru</h1>
    <p class="text-sm text-gray-500">Buat pertanyaan dan jawaban baru untuk ditampilkan di halaman publik.</p>
</div>

<div class="max-w-4xl">
    <form action="<?= base_url('superadmin/faq/store') ?>" method="POST" class="bg-[#111] border border-white/10 rounded-2xl overflow-hidden p-6 md:p-8">
        <?= csrf_field() ?>
        ...
        <div class="space-y-6">
            ...
            <div class="pt-4 flex items-center gap-4">
                ...
                <a href="<?= base_url('superadmin/faq') ?>" class="px-8 py-3 bg-white/5 text-white font-bold rounded-xl hover:bg-white/10 transition">
                    Batal
                </a>
            </div>
        </div>
