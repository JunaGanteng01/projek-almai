...
<div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
    ...
    <a href="<?= base_url('superadmin/event-banner/create') ?>" class="w-full lg:w-auto px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-center whitespace-nowrap">
                        ...
                        <tr class="border-t border-white/10 hover:bg-white/5">
                            ...
                            <td class="px-4 md:px-6 py-3 md:py-4">
                                <div class="flex items-center gap-2">
                                    <a href="<?= base_url('superadmin/event-banner/edit/' . $banner['id']) ?>" class="p-2 text-gray-400 hover:text-white hover:bg-white/10 rounded-lg transition">
...
<script>
    function confirmDelete(id, title) {
        ...
        document.getElementById('deleteForm').action = '<?= base_url('superadmin/event-banner/delete/') ?>' + id;
