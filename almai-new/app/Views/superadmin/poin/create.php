...
<body class="antialiased">
    <div class="min-h-screen p-4 md:p-8">
        <div class="max-w-xl mx-auto">
            <a href="<?= base_url('superadmin/poin') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-6">
            ...
            <div class="bg-[#111] border border-white/10 rounded-2xl p-6 md:p-8">
                ...
                <form action="<?= base_url('superadmin/poin/store') ?>" method="post" class="space-y-4">
                    <?= csrf_field() ?>
                    ...
                    <div class="flex gap-3 pt-4">
                        <a href="<?= base_url('superadmin/poin') ?>" class="flex-1 py-3 border border-white/20 rounded-xl hover:bg-white/5 transition text-center">Batal</a>
