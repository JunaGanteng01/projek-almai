...
<div class="bg-[#111] border border-white/10 rounded-2xl p-4 mb-6 shadow-xl">
    <form action="<?= base_url('superadmin/poin/history') ?>" method="get" class="flex flex-col gap-4">
                ...
                <tr class="hover:bg-white/5 transition group">
                    ...
                    <td class="px-4 py-4">
                        <div class="flex items-center justify-center gap-2">
                            <a href="<?= base_url('superadmin/poin/user/' . $poin['user_id']) ?>" class="w-9 h-9 flex items-center justify-center bg-blue-500/10 text-blue-400 rounded-xl hover:bg-blue-500 hover:text-white transition shadow-sm" title="User History">
...
<script>
    function confirmDelete(id) {
        document.getElementById('deleteForm').action = '<?= base_url('superadmin/poin/delete/') ?>' + id;
