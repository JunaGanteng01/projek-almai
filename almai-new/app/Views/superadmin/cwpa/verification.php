                    ...
                    <?php if (!empty($cwpaList)): ?>
                        ...
                        foreach ($cwpaList as $cwpa): ?>
                            <tr class="hover:bg-white/5 transition">
                                ...
                                <td class="px-6 py-4">
                                    <a href="<?= base_url('superadmin/cwpa/verification/' . $cwpa['id']) ?>"
...
<script>
    function openDetailModal(cwpaId) {
        ...
        // Fetch CWPA details
        fetch(`<?= base_url('superadmin/cwpa/') ?>${cwpaId}`)
    ...
    document.getElementById('verifyForm').addEventListener('submit', function(e) {
        ...
        fetch(`<?= base_url('superadmin/cwpa/verify/') ?>${cwpaId}`, {
                method: 'POST',
                headers: {
    ...
    function unverify(cwpaId, cwpaName) {
        ...
        fetch(`<?= base_url('superadmin/cwpa/unverify/') ?>${cwpaId}`, {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
                }
