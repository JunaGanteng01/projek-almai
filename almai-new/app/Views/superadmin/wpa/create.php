...
<!-- Back Button -->
<div class="mb-6">
    <a href="<?= base_url('superadmin/wpa') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-white transition">
...
<form action="<?= base_url('superadmin/wpa/store') ?>" method="post" enctype="multipart/form-data" class="max-w-3xl">
    <?= csrf_field() ?>
    ...
    <div class="flex gap-4">
        <a href="<?= base_url('superadmin/wpa') ?>" class="flex-1 py-4 border border-white/20 rounded-xl text-center hover:bg-white/5 transition">
            Batal
        </a>
