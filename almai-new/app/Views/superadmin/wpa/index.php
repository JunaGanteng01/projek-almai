...
<div class="flex flex-col gap-4 mb-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <form action="<?= base_url('superadmin/wpa') ?>" method="get" class="w-full relative">
        ...
        <?php if ($canWrite ?? false): ?>
            <a href="<?= base_url('superadmin/wpa/create') ?>" class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-center text-sm whitespace-nowrap shadow-lg shadow-accent/10">
                        ...
                        <tr class="hover:bg-white/5 transition group">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <?php if ($canWrite ?? false): ?>
                                        <a href="<?= base_url('superadmin/wpa/edit/' . $wpa['id']) ?>" class="w-10 h-10 flex items-center justify-center bg-white/5 text-gray-400 rounded-xl hover:bg-white/10 hover:text-white transition shadow-sm" title="Edit">
...
<script>
    function confirmDelete(wpaId, wpaName) {
        ...
        document.getElementById('deleteForm').action = '<?= base_url('superadmin/wpa/delete/') ?>' + wpaId;
