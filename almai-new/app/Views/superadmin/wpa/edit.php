...
<div class="w-full max-w-full mx-auto space-y-6">
    ...
    <div class="flex items-center gap-2 text-sm">
        <a href="<?= base_url('superadmin/wpa') ?>" class="text-gray-400 hover:text-accent transition flex items-center gap-1">
    ...
    <form action="<?= base_url('superadmin/wpa/update/' . $wpa['id']) ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
        ...
        <div class="mt-8 pt-6 border-t border-white/10">
            <div class="flex flex-col sm:flex-row gap-3 justify-end">
                <a href="<?= base_url('superadmin/wpa') ?>" class="order-2 sm:order-1 px-6 py-3 bg-transparent border border-white/20 text-white font-medium text-sm rounded-xl hover:bg-white/5 transition text-center">
                    Batal
                </a>
