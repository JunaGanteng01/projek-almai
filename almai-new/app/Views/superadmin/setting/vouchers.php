...
<body class="antialiased">
    <div class="min-h-screen p-4 md:p-8">
        <div class="max-w-2xl mx-auto">
            <a href="<?= base_url('superadmin/setting') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-6">
            ...
            <div class="bg-[#111] border border-white/10 rounded-2xl p-6 md:p-8 mb-6">
                ...
                <form action="<?= base_url('superadmin/setting/vouchers/save') ?>" method="post" class="space-y-4">
                    <?= csrf_field() ?>
                ...
                <?php else: ?>
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-4 bg-black/50 rounded-xl">
                            ...
                            <form action="<?= base_url('superadmin/setting/vouchers/delete/' . urlencode($code)) ?>" method="post" onsubmit="return confirm('Hapus voucher ini?')">
                                <?= csrf_field() ?>
