    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 md:ml-64 pt-14 md:pt-0">
            ...
            <section class="p-4 md:p-8">
                ...
                <form action="<?= base_url('superadmin/users/store') ?>" method="post" class="max-w-xl">
                    <?= csrf_field() ?>
                    ...
                    <div class="flex gap-4">
                        <a href="<?= base_url('superadmin/users') ?>" class="flex-1 py-4 border border-white/20 rounded-xl text-center hover:bg-white/5 transition">Batal</a>
