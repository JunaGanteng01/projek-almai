...
<div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
    <form action="<?= base_url('superadmin/kyc') ?>" method="get" class="flex flex-col sm:flex-row flex-wrap gap-2 w-full lg:w-auto">
                ...
                <tr class="border-t border-white/10 hover:bg-white/5">
                    ...
                    <td class="px-4 md:px-6 py-3 md:py-4">
                        <div class="flex items-center gap-1">
                            <a href="<?= base_url('superadmin/kyc/detail/' . $user['id']) ?>" 
...
<script>
    function approveKyc(id, name) {
        ...
        document.getElementById('approveForm').action = '<?= base_url('superadmin/kyc/approve/') ?>' + id;
    ...
    function rejectKyc(id, name) {
        ...
        document.getElementById('rejectForm').action = '<?= base_url('superadmin/kyc/reject/') ?>' + id;
