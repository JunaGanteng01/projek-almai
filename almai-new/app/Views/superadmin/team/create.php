...
$pageSubtitle = 'Tambahkan anggota tim baru ke dalam sistem';
?>
...
<div class="max-w-3xl">
    <!-- Back Button -->
    <a href="<?= base_url('superadmin/tim') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-white mb-6 transition">
    ...
    <div class="bg-[#111] border border-white/10 rounded-2xl p-6 md:p-8">
        <form action="<?= base_url('superadmin/tim/store') ?>" method="post" enctype="multipart/form-data" class="space-y-6">
            <?= csrf_field() ?>
            ...
            <?php if (session()->getFlashdata('errors')): ?>
                <div class="bg-red-500/10 border border-red-500/20 rounded-xl p-4 mb-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            <h4 class="text-white font-medium mb-1">Gagal menyimpan data</h4>
            ...
            <div>
                ...
                <input type="number" id="order_number" name="order_number" value="<?= old('order_number', 0) ?>"
            ...
            <div>
                ...
                <p class="mt-2 text-xs text-gray-500">Format: JPG, PNG, GIF. Maks: 2MB. Disarankan rasio 1:1 (persegi).</p>
            </div>
            ...
            <div class="flex items-center gap-4 pt-6 mt-6 border-t border-white/10">
                ...
                <a href="<?= base_url('superadmin/tim') ?>" class="px-6 py-3 bg-white/5 text-white font-medium rounded-xl hover:bg-white/10 transition">
                    Batal
                </a>
            </div>
