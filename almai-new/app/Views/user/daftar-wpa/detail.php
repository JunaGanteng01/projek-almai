...
<section class="wpa-profile-content relative pt-6 md:pt-12 pb-12 overflow-hidden">
    ...
    <div class="px-4 md:px-8 relative z-10">
        ...
        <div class="mb-8 flex items-center gap-4">
            <a href="<?= base_url('user/dashboard/daftar-wpa') ?>" class="w-10 h-10 bg-black/40 border border-white/10 rounded-xl flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition shadow-lg">
                <i class="fas fa-arrow-left"></i>
            </a>
            <div>
                <nav class="flex items-center gap-2 text-[10px] text-gray-500 uppercase tracking-widest font-bold">
                    <a href="<?= base_url('user/dashboard') ?>" class="hover:text-accent">Dashboard</a>
                    <i class="fas fa-chevron-right text-[8px]"></i>
                    <a href="<?= base_url('user/dashboard/daftar-wpa') ?>" class="hover:text-accent">Daftar WPA</a>
                    <i class="fas fa-chevron-right text-[8px]"></i>
            ...
            <div class="md:col-span-8 lg:col-span-9 space-y-12">
                ...
                <div class="bg-[#111] border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
                    ...
                    <div class="phase-timeline-wpa">
                        <?php
                        $phases = [
                            ['number' => 1, 'title' => 'Sertifikasi Multilateral'],
                            ['number' => 2, 'title' => 'Sertifikasi Pelatihan LPK'],
                            ['number' => 3, 'title' => 'Sertifikasi LSP PBK'],
                            ['number' => 4, 'title' => 'Sertifikasi TLUP'],
                            ['number' => 5, 'title' => 'Izin WPA'],
                            ['number' => 6, 'title' => 'Pendaftaran Anggota Asosiasi'],
