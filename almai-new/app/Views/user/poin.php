...
$isPro = !empty($user['level_id']) && $user['level_id'] >= \App\Models\LevelModel::LEVEL_PRO;
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="border-b md:border-b-0 md:border-r border-white/10">
                ...
                <div class="divide-y divide-white/5">
                    <?php 
                    $usageItems = [
                        ['label' => 'Total Redeem', 'value' => $poinStats['redeem'] ?? 0, 'color' => 'text-red-400'],
                        ['label' => 'Artikel', 'value' => $poinStats['artikel'] ?? 0],
                        ['label' => 'Layanan', 'value' => $poinStats['layanan_usage'] ?? 0],
                        ['label' => 'Merchandise', 'value' => $poinStats['merchandise'] ?? 0],
                        ['label' => 'Berbagi Poin', 'value' => $poinStats['share_out'] ?? 0],
                    ];
            ...
            <div>
                ...
                <div class="divide-y divide-white/5">
                    <?php 
                    $earnItems = [
                        ['label' => 'Total Bonus', 'value' => $poinStats['bonus_total'] ?? 0, 'color' => 'text-emerald-400'],
                        ['label' => 'Poin Register', 'value' => $poinStats['register'] ?? 0],
                        ['label' => 'Poin Referral', 'value' => $poinStats['referral'] ?? 0],
                        ['label' => 'Poin Layanan', 'value' => $poinStats['layanan_earn'] ?? 0],
                        ['label' => 'Terima Poin', 'value' => $poinStats['share_in'] ?? 0],
                    ];
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    ...
    <div class="md:col-span-1">
        <div class="bg-[#111] border border-white/10 rounded-2xl p-6 h-full flex flex-row md:flex-col items-center justify-between md:justify-center gap-4 text-center">
            ...
            <a href="<?= base_url('user/poin/buy') ?>" class="bg-accent hover:bg-white text-black font-black text-[10px] md:text-xs uppercase tracking-widest px-6 md:w-full py-3 md:py-4 rounded-xl transition shadow-xl shadow-green-900/20 active:scale-95">
                Beli Point
            </a>
        </div>
    </div>
