...
<body class="antialiased">
    ...
    <div class="flex flex-col lg:flex-row min-h-screen relative overflow-hidden">
        ...
        <div class="lg:hidden fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a] border-b border-white/10 px-4 py-3 flex justify-between items-center">
            <a href="<?= base_url('user/advokasi') ?>" class="flex items-center gap-2 text-gray-400 hover:text-white">
        ...
        <aside id="sidebar" class="w-full lg:w-80 bg-[#0a0a0a] border-r border-white/10 fixed lg:relative h-full z-40 transform -translate-x-full lg:translate-x-0 transition-transform overflow-y-auto custom-scrollbar">
            <div class="p-4 border-b border-white/10 sticky top-0 bg-[#0a0a0a] z-10">
                <a href="<?= base_url('user/advokasi') ?>" class="hidden lg:flex items-center gap-2 text-gray-400 hover:text-white mb-4">
                    <i class="fas fa-arrow-left"></i>
                    <span class="text-sm">Kembali ke Advokasi</span>
                </a>
                <span class="text-[9px] font-black text-accent uppercase tracking-widest mb-1 block">Pusat Advokasi Almai</span>
                <h2 class="font-black text-lg leading-tight text-white tracking-tighter uppercase" id="kelasTitle">PROGRAM ADVOKASI TRADER PROFESIONAL (7 HARI)</h2>
                <div class="flex items-center gap-2 mt-2">
                    ...
                    <span class="text-[10px] text-gray-400 font-medium tracking-tight">Sistem Terintegrasi: Legalitas • Market • Risiko • Evaluasi • Strategi • Teknologi • Perlindungan</span>
                </div>
            </div>
        ...
        <main class="flex-1 pt-14 lg:pt-0 relative">
            <!-- Heritage Branding Banner (Moved from Index) -->
            <div class="px-6 py-8">
                <div class="p-6 md:p-8 bg-gradient-to-br from-accent/20 to-transparent rounded-[2rem] border border-accent/10 relative overflow-hidden shadow-2xl">
                    <div class="relative z-10">
                        <h2 class="text-xl md:text-2xl font-black text-white mb-2 uppercase tracking-tight">Pusat Advokasi Almai</h2>
                        <p class="text-gray-400 text-xs max-w-lg leading-relaxed">
                            Pusat edukasi investigasi dan pendampingan hukum. Pahami hak Anda sebagai trader dan tingkatkan keamanan finansial Anda di sini.
                        </p>
                    </div>
                    <div class="absolute -right-6 -bottom-6 opacity-10">
                        <i class="fas fa-shield-halved text-[100px] text-accent"></i>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        const modules = [
            ...
            { 
                ...
                output: 'Trader memiliki strategi yang stabil and berkelanjutan.',
                topics: [
                    {
            ...
            { 
                ...
                output: 'Trader terlindungi secara sistem and memiliki alat bantu untuk meningkatkan kualitas keputusan trading.',
                topics: [
                    {
        ...
        function nextModule() {
            if (currentTopicIndex < modules[currentModuleIndex].topics.length - 1) {
                ...
                Swal.fire({
                    ...
                    text: 'Program ini dirancang for membentuk trader secara menyeluruh: tidak hanya profit-oriented, tetapi juga legal, terstruktur, berbasis sistem, didukung teknologi, dan memiliki perlindungan.',
                    icon: 'success',
                    background: '#0a0a0a',
                    color: '#ffffff',
