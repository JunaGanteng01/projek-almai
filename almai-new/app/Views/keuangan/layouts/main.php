...
<head>
    ...
    <title><?= esc($title ?? 'Finance & Accounting - Almai') ?></title>
...
<style>
    ...
    .sidebar-link.active { background: linear-gradient(90deg, rgba(51,232,24,0.2) 0%, transparent 100%); border-left: 3px solid #33e818; color: #fff !important; }
...
<body class="antialiased">
    ...
    <!-- Susani AI Accounting Assistant Widget -->
    <?= $this->include('keuangan/partials/ai_assistant') ?>
</body>
</html>
