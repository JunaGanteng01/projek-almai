<?php $this->setVar('pageTitle', 'Manajemen Penarikan WPA'); ?>
<?= $this->extend('keuangan/layouts/main') ?>

<?= $this->section('content') ?>
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
    <h1 class="text-2xl font-bold">Manajemen Penarikan Funds WPA</h1>
    <div class="flex flex-wrap gap-2">
        ...
        <a href="<?= base_url('keuangan/withdrawals') ?>" class="px-4 py-2 bg-white/5 text-gray-400 rounded-lg text-sm border <?= empty($currentStatus) ? 'border-white/20' : 'border-transparent' ?> hover:bg-white/10 transition">
            Semua
        </a>
    </div>
</div>
        ...
        <table class="w-full">
            <thead>
                <tr class="text-left bg-black text-white">
                    <th class="px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-wider">WPA Profile</th>
                        ...
                        <tr class="hover:bg-white/5 transition group">
                            <td class="px-6 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-bold text-white group-hover:text-accent transition"><?= esc($wd['wpa_name']) ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm">
...
<div id="statusModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 hidden transition-all">
    <div class="bg-[#111] border border-white/10 rounded-3xl w-full max-w-md p-8 shadow-2xl">
        <div class="flex items-center justify-between mb-6">
            <h3 class="text-xl font-bold italic">Update Penarikan</h3>
        ...
        <form id="updateForm" method="post" action="">
            ...
            <div class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Catatan Keuangan</label>
                    <textarea name="admin_notes" id="modalNotes" rows="4"
                        ...
                        placeholder="Info bukti transfer atau alasan penolakan..."></textarea>
                </div>
...
<script>
    function openModal(id, currentStatus, notes) {
        ...
        form.action = `<?= base_url('keuangan/withdrawals/update') ?>/${id}`;
