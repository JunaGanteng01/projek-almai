...
<form action="<?= base_url('keuangan/perubahan-modal') ?>" method="get" class="flex flex-col md:flex-row gap-4 items-end mb-8 print:hidden">
    ...
    <div class="flex gap-2 w-full md:w-auto">
        ...
        <a href="<?= base_url('keuangan/perubahan-modal/export-excel?' . http_build_query(service('request')->getGet())) ?>" target="_blank" class="flex-1 md:flex-none px-6 py-2.5 bg-green-500/20 text-green-400 border border-green-500/50 hover:bg-green-500/30 font-bold rounded-xl transition flex items-center justify-center whitespace-nowrap">
