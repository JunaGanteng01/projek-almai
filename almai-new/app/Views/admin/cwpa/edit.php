...
<div class="w-full max-w-full mx-auto space-y-6">
    ...
    <form id="mainEditForm" action="<?= base_url('admin/cwpa/update/' . $cwpa['id']) ?>" method="post" enctype="multipart/form-data">
        <?= csrf_field() ?>
            ...
            <div class="lg:col-span-9 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <div class="relative flex">
                                        ...
                                        <input type="text" name="instagram" value="<?= old('instagram', $cwpa['instagram'] ?? '') ?>" class="min-w-0 flex-1 rounded-r-xl rounded-l-none border border-white/20 bg-black py-3 pr-4 pl-3 text-white focus:border-accent focus:outline-none transition" placeholder="@username">
                                    </div>
                                </div>
                ...
                <div class="bg-[#111] border border-white/10 rounded-2xl overflow-hidden">
                    ...
                    <div class="divide-y divide-white/5">
                        ...
                        ?>
                            <div class="px-6 md:px-8 py-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4 hover:bg-white/[0.02] transition-colors group">
...
<script>
    ...
    function executePromotion() {
        ...
        f.method = 'POST';
        f.action = '<?= base_url('admin/cwpa/promote/' . $cwpa['id']) ?>';
