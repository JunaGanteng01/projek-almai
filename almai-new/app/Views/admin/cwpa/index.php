...
<div class="flex flex-col gap-4 mb-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
        <form action="<?= base_url('admin/cwpa') ?>" method="get" class="w-full relative">
        ...
        <a href="<?= base_url('admin/cwpa/create') ?>" class="w-full flex items-center justify-center gap-2 px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-center text-sm whitespace-nowrap shadow-lg shadow-accent/10">
                        ...
                        <tr class="hover:bg-white/5 transition group">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <a href="<?= base_url('admin/cwpa/edit/' . $cwpa['id']) ?>" class="w-10 h-10 flex items-center justify-center bg-white/5 text-gray-400 rounded-xl hover:bg-white/10 hover:text-white transition shadow-sm" title="Edit">
...
<script>
    function openCwpaDeleteModal(id, name) {
        ...
        form.action = '<?= base_url('admin/cwpa/delete/') ?>' + id;
