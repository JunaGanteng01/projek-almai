...
<div class="space-y-6">
    <!-- Back Button -->
    <div>
        <a href="<?= base_url('admin/cwpa/verification') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-white transition">
...
<script>
    ...
    document.getElementById('verifyForm').addEventListener('submit', function(e) {
        ...
        fetch(`<?= base_url('admin/cwpa/') ?>${endpoint}/${cwpaId}`, {
                method: 'POST',
                headers: {
