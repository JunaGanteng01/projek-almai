...
<div class="w-full">
    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="<?= base_url('admin/transaksi') ?>" class="px-5 py-2.5 bg-[#111] border border-white/10 rounded-xl text-gray-400 hover:text-white transition flex items-center gap-2">
    ...
    <!-- Form Area -->
    <form action="<?= base_url('admin/transaksi/store-manual') ?>" method="POST" class="space-y-6">
        <?= csrf_field() ?>
