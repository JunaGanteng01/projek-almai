...
<div class="bg-[#111] border border-white/10 rounded-2xl p-4 mb-6 shadow-xl">
    <form action="<?= base_url('admin/transaksi') ?>" method="get" class="flex flex-col gap-4">
        <!-- Main Filters Group -->
                        ...
                        <tr class="hover:bg-white/5 transition group">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?= base_url('admin/transaksi/detail/' . $trx['id']) ?>" class="w-9 h-9 flex items-center justify-center bg-white/5 text-gray-400 rounded-xl hover:bg-white/10 hover:text-white transition shadow-sm" title="Lihat Detail">
...
<script>
    function openStatusModal(id, currentStatus) {
        document.getElementById('statusForm').action = '<?= base_url('admin/transaksi/update-status/') ?>' + id;
