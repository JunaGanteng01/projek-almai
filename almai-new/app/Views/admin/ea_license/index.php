                            ...
                            <tr class="hover:bg-white/5 transition">
                                ...
                                <td class="p-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <button type="button" onclick="confirmDelete('<?= base_url('admin/ea-license/delete/' . $lic['id']) ?>')" 
...
function editLicense(id, licenseKey, acc) {
    ...
    form.action = '<?= base_url('admin/ea-license/update/') ?>' + id;
...
function extendLicense(id, acc) {
    ...
    form.action = '<?= base_url('admin/ea-license/extend/') ?>' + id;
