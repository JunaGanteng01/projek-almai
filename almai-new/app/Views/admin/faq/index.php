...
<div class="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
    ...
    <a href="<?= base_url('admin/faq/create') ?>" class="w-full sm:w-auto px-6 py-2 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-center whitespace-nowrap">
                        ...
                        <tr class="border-t border-white/5 hover:bg-white/5 transition-colors">
                            ...
                            <td class="px-4 py-4 text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?= base_url('admin/faq/edit/' . $faq['id']) ?>" class="w-8 h-8 flex items-center justify-center bg-blue-500/20 text-blue-400 rounded-lg hover:bg-blue-500 hover:text-white transition" title="Edit">
                                    ...
                                    <form id="delete-form-<?= $faq['id'] ?>" action="<?= base_url('admin/faq/delete/' . $faq['id']) ?>" method="POST" class="hidden">
                                        <?= csrf_field() ?>
                                    </form>
                                </div>
                            </td>
