...
<div class="mb-6">
    <a href="<?= base_url('admin/users') ?>" class="inline-flex items-center gap-2 text-gray-400 hover:text-white transition">
    ...
    <div class="lg:col-span-2 space-y-6">
                        ...
                        <tbody class="divide-y divide-white/5">
                            <?php foreach ($purchasedServices as $service): ?>
                                <tr class="hover:bg-white/5 transition">
                                    ...
                                    <td class="py-3 px-2">
                                        <a href="<?= base_url('admin/transaksi/detail/' . $service['id']) ?>" class="text-xs font-mono text-accent hover:underline">
                                    ...
                                    <td class="py-3 px-2 text-right">
                                        <?php if ($service['status'] === 'confirmed' || $service['status'] === 'paid'): ?>
                                            <div class="flex justify-end gap-2">
                                                <a href="<?= base_url('admin/users/download-agreement/' . $service['id'] . '/perjanjian') ?>"
                                                ...
                                                <a href="<?= base_url('admin/users/download-agreement/' . $service['id'] . '/risiko') ?>"
                                                    class="p-1.5 bg-white/5 hover:bg-accent/20 text-gray-400 hover:text-accent rounded-lg transition"
                                    ...
                                    <tr class="downline-row hover:bg-white/5 transition"
                                        ...
                                        <td class="py-2 px-2">
                                            <div class="flex items-center gap-2">
                                                ...
                                                <a href="<?= base_url('admin/users/view/' . $downline['id']) ?>" class="font-medium text-xs hover:text-accent transition truncate"><?= esc($downline['name']) ?></a>
                                            </div>
                                        </td>
        ...
        <div class="bg-[#111] border border-white/10 rounded-2xl p-6">
            ...
            <div class="flex flex-col sm:flex-row flex-wrap gap-3">
                <a href="<?= base_url('admin/users/edit/' . $user['id']) ?>" class="w-full sm:w-auto px-4 py-2 bg-blue-500/20 text-blue-400 rounded-xl hover:bg-blue-500 hover:text-white transition text-sm text-center">
                    <i class="fas fa-edit mr-2"></i> Edit User
                </a>
                <a href="<?= base_url('admin/users/toggle-status/' . $user['id']) ?>" class="w-full sm:w-auto px-4 py-2 bg-yellow-500/20 text-yellow-400 rounded-xl hover:bg-yellow-500 hover:text-black transition text-sm text-center">
                    <i class="fas fa-power-off mr-2"></i> Toggle Status
                </a>
                <?php if (!empty($user['kyc_status']) || !empty($kyc)): ?>
                    <a href="<?= base_url('admin/kyc/detail/' . $user['id']) ?>" class="w-full sm:w-auto px-4 py-2 bg-purple-500/20 text-purple-400 rounded-xl hover:bg-purple-500 hover:text-white transition text-sm text-center">
                ...
                ?>
                    <form id="deleteForm-<?= $user['id'] ?>" action="<?= base_url('admin/users/delete/' . $user['id']) ?>" method="post" class="w-full sm:w-auto inline">
                        <?= csrf_field() ?>
