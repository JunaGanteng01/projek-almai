    ...
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 md:ml-64 pt-14 md:pt-0">
            ...
            <section class="p-4 md:p-8">
                ...
                <form action="<?= base_url('admin/users/update/' . $user['id']) ?>" method="post" class="max-w-4xl">
                    <?= csrf_field() ?>
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="flex gap-3">
                                <a href="<?= base_url('admin/users') ?>" class="flex-1 py-3 border border-white/20 rounded-xl text-center hover:bg-white/5 transition">
                                    Batal
                                </a>
