                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        ...
                        <div class="flex items-center gap-2">
                             <a href="<?= base_url('admin/poin-package/toggle/' . $pkg['id']) ?>" class="p-2 <?= $pkg['is_enabled'] ? 'text-accent' : 'text-gray-500' ?> hover:bg-white/5 rounded-lg transition" title="Toggle Aktif">
                            ...
                            <button onclick="confirmDelete('<?= base_url('admin/poin-package/delete/' . $pkg['id']) ?>')" class="p-2 text-red-400 hover:bg-red-400/10 rounded-lg transition">
...
<div id="modalAdd" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md p-6">
        <div class="bg-[#111] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
            ...
            <form action="<?= base_url('admin/poin-package/create') ?>" method="post" class="p-6 space-y-4">
                <div>
...
<script>
    ...
    function openEditModal(pkg) {
        ...
        document.getElementById('editForm').action = '<?= base_url('admin/poin-package/update') ?>/' + pkg.id;
        openModal('modalEdit');
    }
