...
<div class="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 mb-6">
    ...
    <a href="<?= base_url('admin/voucher/create') ?>" class="w-full lg:w-auto px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-center whitespace-nowrap">
                ...
                <tr class="border-t border-white/5 hover:bg-white/5">
                    ...
                    <td class="px-4 py-3">
                        <div class="flex items-center justify-center gap-1">
                            <a href="<?= base_url('admin/voucher/usages/' . $voucher['id']) ?>" class="p-2 bg-blue-500/20 text-blue-400 rounded-lg hover:bg-blue-500 hover:text-white transition" title="Riwayat">
                                <i class="fas fa-history text-xs"></i>
                            </a>
                            <a href="<?= base_url('admin/voucher/edit/' . $voucher['id']) ?>" class="p-2 bg-accent/20 text-accent rounded-lg hover:bg-accent hover:text-black transition" title="Edit">
                                <i class="fas fa-edit text-xs"></i>
                            </a>
                            <form action="<?= base_url('admin/voucher/toggle-status/' . $voucher['id']) ?>" method="post" class="inline">
                                <?= csrf_field() ?>
                            ...
                            <form action="<?= base_url('admin/voucher/delete/' . $voucher['id']) ?>" method="post" class="inline" onsubmit="return confirm('Hapus voucher ini?')">
                                <?= csrf_field() ?>
