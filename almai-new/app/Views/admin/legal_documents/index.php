...
<div class="max-w-7xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="<?= base_url('admin/legal-documents/create') ?>" class="px-6 py-3 bg-accent hover:bg-accent/80 text-black font-semibold rounded-lg transition-colors">
                    ...
                    <?php if (empty($documents)): ?>
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center text-gray-400">
                                ...
                                <a href="<?= base_url('admin/legal-documents/create') ?>" class="inline-block mt-3 text-accent hover:underline">
                            ...
                            <tr class="hover:bg-white/5 transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        ...
                                        <a href="<?= base_url('admin/legal-documents/edit/' . $doc['id']) ?>" 
...
<script>
    function toggleStatus(id, currentStatus) {
        if (confirm('Ubah status dokumen ini?')) {
            fetch(`<?= base_url('admin/legal-documents/toggle-active/') ?>${id}`, {
                method: 'POST',
                headers: {
    ...
    function previewDocument(id) {
        ...
        fetch(`<?= base_url('admin/legal-documents/preview/') ?>${id}`)
    ...
    function deleteDocument(id, title) {
        if (confirm(`Hapus dokumen "${title}"?\n\nTindakan ini tidak dapat dibatalkan.`)) {
            window.location.href = `<?= base_url('admin/legal-documents/delete/') ?>${id}`;
        }
    }
