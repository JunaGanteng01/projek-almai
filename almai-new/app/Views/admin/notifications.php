...
<div class="p-0">
    ...
    <div class="bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden">
        <div class="p-4 border-b border-white/10 flex justify-between items-center">
            ...
            if ($unreadCount > 0): 
            ?>
            <a href="<?= base_url('admin/notifications/read-all') ?>" class="text-sm text-accent hover:underline">Tandai semua dibaca</a>
            <?php endif; ?>
        </div>
        ...
        <div class="divide-y divide-white/5">
            ...
            <a href="<?= base_url('admin/notifications/read/' . $notif['id']) ?>" class="block px-4 py-4 hover:bg-white/5 transition <?= $notif['is_read'] ? 'opacity-60' : '' ?>">
