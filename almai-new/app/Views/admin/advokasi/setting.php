...
<div class="mb-8 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
    ...
    <a href="<?= base_url('admin/advokasi') ?>" class="inline-flex items-center gap-2 px-5 py-2.5 bg-white/5 border border-white/10 text-white font-bold rounded-xl hover:bg-white/10 transition text-sm">
...
<form action="<?= base_url('admin/advokasi/save-setting') ?>" method="post" enctype="multipart/form-data">
    <?= csrf_field() ?>
