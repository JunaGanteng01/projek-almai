...
<section class="p-0">
    ...
    <div class="mt-6 bg-[#111] border border-white/10 rounded-xl md:rounded-2xl p-4 md:p-6">
        <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-4">
            ...
            <a href="<?= base_url('admin/setting/vouchers') ?>" class="w-full sm:w-auto px-4 py-2 bg-accent/20 text-accent rounded-xl hover:bg-accent hover:text-black transition text-sm text-center">
