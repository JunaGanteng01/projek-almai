...
<div class="space-y-6">
    <div class="flex items-center gap-4">
        <a href="<?= base_url('admin/layanan') ?>" class="p-2 hover:bg-white/10 rounded-lg">
    ...
    <form action="<?= base_url('admin/layanan/update/' . $layananType . '/' . $layanan['id']) ?>" method="POST" enctype="multipart/form-data" id="wizardForm">
        <?= csrf_field() ?>
