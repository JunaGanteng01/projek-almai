...
<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold">Tambah Layanan Software / EA</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div>
                    ...
                    <select name="subcategory" id="subcategorySelect" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3">
                        <?php $reqSub = $_GET['sub'] ?? ''; ?>
                        <option value="ea" <?= $reqSub == 'ea' ? 'selected' : '' ?>>Expert Advisor (EA)</option>
                        <option value="toolkit" <?= $reqSub == 'toolkit' ? 'selected' : '' ?>>Almai Toolkits</option>
                    </select>
                </div>
                <div>
            ...
            <div class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="slug" class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3" placeholder="contoh-nama-ea">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="fitur_unggulan" rows="3" class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3 font-mono text-sm" placeholder='[{"name": "Auto Trading", "link": ""}]'></textarea>
                </div>
            </div>
        </div>
