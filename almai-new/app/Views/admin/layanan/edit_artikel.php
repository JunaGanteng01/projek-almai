...
<div class="space-y-6">
    <div class="flex items-center gap-4">
        ...
        <div>
            <h1 class="text-2xl font-bold">Edit Layanan Artikel / E-Book</h1>
        ...
        <div class="bg-[#111] border border-white/10 rounded-xl p-6 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="<?= esc($layanan['slug'] ?? '') ?>"   class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3" placeholder="contoh-judul-artikel">
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="description" rows="3" class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3"><?= esc($layanan['description'] ?? '') ?></textarea>
                </div>
                <div>
                    <label class="block text-sm text-gray-400 mb-2">Layanan Utama (Poin-poin)</label>
                    <textarea name="layanan_utama" rows="3" class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3" placeholder="Sebutkan 3-5 poin utama..."><?= esc($layanan['layanan_utama'] ?? '') ?></textarea>
                </div>
                <div>
                    <label class="block text-sm text-gray-400 mb-2">Fitur Unggulan (JSON Format)</label>
                    <textarea name="fitur_unggulan" rows="4" class="w-full bg-[#0a0a0a] border border-white/10 rounded-lg px-4 py-3 font-mono text-sm" placeholder='[{"name": "Materi PDF", "link": "https://..."}]'><?= esc($layanan['fitur_unggulan'] ?? '') ?></textarea>
                </div>
            </div>
        </div>
