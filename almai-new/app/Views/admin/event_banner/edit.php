...
<div class="max-w-4xl">
    <div class="bg-[#111] border border-white/10 rounded-2xl md:rounded-3xl overflow-hidden p-6 md:p-10">
        <form action="<?= base_url('admin/event-banner/update/' . $banner['id']) ?>" method="post" enctype="multipart/form-data">
            <?= csrf_field() ?>
            ...
            <div class="space-y-6">
                ...
                <div class="flex flex-col md:flex-row gap-4 pt-10 border-t border-white/5">
                    <a href="<?= base_url('admin/event-banner') ?>" class="px-8 py-3 border border-white/10 text-gray-400 rounded-xl hover:bg-white/5 text-center transition">Batal</a>
