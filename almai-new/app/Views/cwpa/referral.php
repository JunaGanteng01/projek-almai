...
<div class="w-full max-w-full pb-32 pt-4 md:pt-0">
    <!-- Header -->
    <div class="mb-6 md:mb-8">
        <h1 class="text-2xl md:text-3xl font-bold text-white mb-2">Sistem Referral</h1>
                        ...
                        <div class="bg-gradient-to-r from-[#33E818]/10 to-transparent border border-[#33E818]/20 rounded-xl p-4 mb-6">
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <form action="<?= base_url('cwpa/dashboard/referral/update') ?>" method="POST" class="flex flex-col sm:flex-row gap-3" id="customReferralForm">
                                        <?= csrf_field() ?>
