...
<div class="max-w-4xl mx-auto py-8">
    <div class="mb-10 flex items-center justify-between">
        ...
        <a href="<?= base_url('cwpa/dashboard/advokasi') ?>" class="px-5 py-2.5 bg-white/5 border border-white/10 text-white text-xs font-bold uppercase tracking-widest rounded-xl hover:bg-white/10 transition flex items-center gap-2">
    ...
    <div class="bg-[#111] border border-white/10 rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
        ...
        <form id="reportForm" action="<?= base_url('cwpa/dashboard/advokasi/submit-laporan') ?>" method="POST" enctype="multipart/form-data" class="relative z-10">
            <?= csrf_field() ?>
