...
<div class="space-y-6">
    <div class="flex items-center gap-4">
        <a href="<?= base_url('cwpa/dashboard/absensi') ?>" class="p-2 hover:bg-white/10 rounded-lg">
    ...
    <div class="bg-[#111] border border-white/10 rounded-xl p-6">
        <form action="<?= base_url('cwpa/dashboard/absensi/store') ?>" method="POST" class="space-y-6">
            <?= csrf_field() ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <!-- cwpa_id is automatically assigned via controller from session -->
