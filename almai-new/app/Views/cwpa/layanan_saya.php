...
<div class="flex justify-between items-center mb-6">
    ...
    <a href="<?= base_url('cwpa/dashboard/daftar-layanan') ?>" class="px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-sm">
...
<?php if (empty($myKelas)): ?>
    <div class="bg-[#111] border border-white/10 rounded-xl p-12 text-center">
        ...
        <a href="<?= base_url('cwpa/dashboard/daftar-layanan') ?>" class="inline-block px-6 py-3 bg-accent text-black font-bold rounded-xl hover:bg-white transition text-sm">Jelajahi Layanan</a>
    </div>
<?php else: ?>
            ...
            <div class="group bg-[#111] border border-white/5 rounded-2xl overflow-hidden hover:border-accent/30 transition-all duration-300 flex flex-col shadow-lg">
                ...
                <div class="p-4 flex flex-col flex-1">
                    ...
                    <div class="mt-auto flex gap-2">
                        <a href="<?= base_url('cwpa/dashboard/layanan-detail/' . ($kelas['layanan_id'] ?? $kelas['kelas_id']) . '?trx=' . $kelas['id']) ?>"
