...
<div class="grid md:grid-cols-3 gap-6">
    ...
    <div class="md:col-span-2 space-y-6">
        ...
        <div class="bg-[#111] border border-white/10 rounded-2xl p-6">
            ...
            <form action="<?= base_url('cwpa/dashboard/withdraw/store') ?>" method="post" class="space-y-4">
                <?= csrf_field() ?>
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="bank_name" required readonly
                            value="<?= esc($userBank['bank_name'] ?? '') ?>"
                            class="w-full bg-black border border-white/10 rounded-xl px-4 py-3 focus:outline-none opacity-70 cursor-not-allowed"
                            placeholder="Nama Bank">
                    </div>
                    <div>
                        <label class="block text-sm text-gray-400 mb-2">Nomor Rekening</label>
                        <input type="text" name="account_number" required readonly
                            value="<?= esc($userBank['account_number'] ?? '') ?>"
                            class="w-full bg-black border border-white/10 rounded-xl px-4 py-3 focus:outline-none opacity-70 cursor-not-allowed"
                ...
                <div>
                    ...
                    <input type="text" name="account_holder" required readonly
                        value="<?= esc($userBank['account_holder'] ?? '') ?>"
                        class="w-full bg-black border border-white/10 rounded-xl px-4 py-3 focus:outline-none opacity-70 cursor-not-allowed"
