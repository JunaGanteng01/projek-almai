...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="<?= base_url('cwpa/dashboard') ?>" class="flex items-center gap-1.5 bg-[#111] hover:bg-[#1a1a1a] text-gray-300 hover:text-white border border-white/10 rounded-lg px-3 py-1.5 transition text-xs font-medium">
