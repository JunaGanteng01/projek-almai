...
<head>
    ...
    <title><?= lang('Errors.whoops') ?> | Almai</title>
...
<body class="flex items-center justify-center min-h-screen relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 relative z-10 text-center">
        ...
        <!-- Whoops Text -->
        <h1 class="text-7xl md:text-9xl font-black text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-600 mb-4 tracking-tighter">500</h1>

        <h2 class="text-2xl md:text-4xl font-bold mb-6 text-white">Internal Server Error</h2>

        <p class="text-gray-400 text-lg mb-10 max-w-lg mx-auto">
            Mohon maaf sistem dalam perbaikan , Silakan coba beberapa saat lagi
        </p>
