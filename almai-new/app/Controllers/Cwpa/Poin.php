...
class Poin extends BaseController
{
    public function index()
    {
        ...
        // Fetch CWPA ID properly (logic from Dashboard)
        ...
        return view('cwpa/poin/index', [
            'title' => 'Almai Poin - CWPA Dashboard',
            'activeMenu' => 'poin',
    ...
    public function merchandise()
    {
        ...
        return view('cwpa/poin/merchandise', [
    ...
    public function purchase()
    {
        ...
        $invoiceData = [
            ...
            'success_url' => base_url('cwpa/dashboard/poin/purchase-success?invoice=' . $invoiceNumber),
            'failure_url' => base_url('cwpa/dashboard/poin/purchase-failed?invoice=' . $invoiceNumber),
        ];
    ...
    public function purchaseSuccess()
    {
        ...
        return redirect()->to('/cwpa/dashboard/poin')->with('success', 'Pembayaran sedang diproses. Poin akan ditambahkan setelah pembayaran dikonfirmasi.');
    }
    ...
    {
        $invoiceNumber = $this->request->getGet('invoice');
        return redirect()->to('/cwpa/dashboard/poin')->with('error', 'Pembayaran gagal atau dibatalkan. Silakan coba lagi.');
    }
}
