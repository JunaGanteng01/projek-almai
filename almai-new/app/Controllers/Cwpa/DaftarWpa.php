...
class DaftarWpa extends BaseController
{
    public function index()
    {
        ...
        return view('cwpa/daftar-wpa/index', [
            'title' => 'Daftar WPA - CWPA Dashboard',
    ...
    public function detail($slug)
    {
        ...
        return view('cwpa/daftar-wpa/detail', [
            'title' => $wpa['name'] . ' - CWPA Dashboard',
            'activeMenu' => 'daftar-wpa',
            'wpa' => $wpa,
    ...
    public function layananDetail($slug)
    {
        ...
        return view('cwpa/daftar-wpa/lihat-layanan', [
            'title' => $layanan['name'] . ' - CWPA Dashboard',
            'layanan' => $layanan,
            'packages' => $packages,
            'reviews' => $reviews,
