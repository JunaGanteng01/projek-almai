...
class PoinSharing extends BaseController
{
    ...
    public function create()
    {
        ...
        if (!$cwpaId) return redirect()->back()->with('error', 'Session expired');
        ...
        return view('cwpa/poin/share', [
            'title' => 'Berbagi Poin (CWPA)',
            'user' => $user,
            'userData' => $userData,
            'packages' => $packages,
    ...
    public function store()
    {
        ...
        return redirect()->to('/cwpa/dashboard/poin/share')->with('success', 'Link berbagi poin berhasil dibuat!');
    }
