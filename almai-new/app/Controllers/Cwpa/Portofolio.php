...
class Portofolio extends BaseController
{
    public function index()
    {
        ...
        return view('cwpa/portofolio/index', $data);
    }
    ...
    public function create()
    {
        ...
        if ($count >= 3) {
            return redirect()->to('/cwpa/dashboard/portofolio')->with('error', 'Batas maksimal portofolio adalah 3 akun. Hapus salah satu jika ingin menambah baru.');
        }
        ...
        return view('cwpa/portofolio/create', $data);
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('/cwpa/dashboard/portofolio')->with('success', 'Portofolio berhasil dibuat! Silakan download EA di bawah dan pasang di MT5.');
    }
    ...
    public function delete($id)
    {
        ...
        if ($acc) {
            $model->delete($id);
            return redirect()->to('/cwpa/dashboard/portofolio')->with('success', 'Portofolio berhasil dihapus.');
        }
        
        return redirect()->to('/cwpa/dashboard/portofolio')->with('error', 'Akses ditolak.');
    }
}
