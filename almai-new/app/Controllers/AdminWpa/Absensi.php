...
class Absensi extends BaseController
{
    ...
    {
        $wpaId = $this->getWpaId();
        if (!$wpaId) return redirect()->to('/admin-wpa/dashboard');
        ...
        return view('admin_wpa/absensi/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin_wpa/absensi/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($model->insert($data)) {
            return redirect()->to('/admin-wpa/absensi')->with('success', 'Absensi berhasil dibuat. Link: ' . $linkAbsensi);
        } else {
    ...
    public function delete($kegiatanType, $id)
    {
        ...
        if ($model->delete($id)) {
            return redirect()->to('/admin-wpa/absensi')->with('success', 'Data absensi berhasil dihapus.');
        }
    ...
    public function detail($kegiatanType, $id)
    {
        ...
        $kegiatan = $model->find($id);
        if (!$kegiatan || $kegiatan['wpa_id'] != $wpaId) {
            return redirect()->to('/admin-wpa/absensi')->with('error', 'Kegiatan tidak ditemukan atau bukan milik Anda');
        }
        ...
        return view('admin_wpa/absensi/detail', $data);
    }
