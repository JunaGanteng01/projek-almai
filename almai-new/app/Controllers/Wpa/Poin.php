...
class Poin extends BaseController
{
    ...
    public function purchaseSuccess()
    {
        ...
        return redirect()->to('/wpa/dashboard/poin')->with('success', 'Pembayaran sedang diproses. Poin akan ditambahkan setelah pembayaran dikonfirmasi.');
    }
    ...
    {
        $invoiceNumber = $this->request->getGet('invoice');
        return redirect()->to('/wpa/dashboard/poin')->with('error', 'Pembayaran gagal atau dibatalkan. Silakan coba lagi.');
    }
}
