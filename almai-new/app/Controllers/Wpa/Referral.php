...
class Referral extends BaseController
{
    public function index()
    {
        ...
        return view('wpa/referral', [
            'title' => 'Sistem Referral - WPA Dashboard',
            'activeMenu' => 'referral',
            'user' => $user,
            'wpa' => $wpa,
        ]);
    ...
    public function update()
    {
        ...
        return redirect()->to('/wpa/dashboard/referral')->with('success', 'Kode referral berhasil diubah! Kode ini bersifat permanen dan tidak bisa diubah lagi.');
    }
}
