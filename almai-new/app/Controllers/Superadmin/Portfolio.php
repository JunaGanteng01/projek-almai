...
class Portfolio extends BaseController
{
    public function index()
    {
        ...
        return view('superadmin/portfolio/index', $data);
    }
    ...
    public function delete($id)
    {
        ...
        if ($model->find($id)) {
            $model->delete($id);
            return redirect()->to('/superadmin/portfolio')->with('success', 'Portofolio berhasil dihapus.');
        }
        return redirect()->to('/superadmin/portfolio')->with('error', 'Data tidak ditemukan.');
    }
}
