...
class PoinPackage extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin/poin-package/index', $data);
    }
    ...
    public function create()
    {
        ...
        return redirect()->to('/superadmin/poin-package')->with('success', 'Paket poin berhasil ditambahkan');
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/superadmin/poin-package')->with('success', 'Paket poin berhasil diperbarui');
    }

    public function delete($id)
    {
        $this->poinPackageModel->delete($id);
        return redirect()->to('/superadmin/poin-package')->with('success', 'Paket poin berhasil dihapus');
    }
    ...
    public function toggle($id)
    {
        ...
        return redirect()->to('/superadmin/poin-package')->with('success', 'Status paket berhasil diubah');
    }
}
