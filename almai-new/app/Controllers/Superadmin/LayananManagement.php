...
class LayananManagement extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin/layanan/index', [
    ...
    public function create()
    {
        if (!$this->canWriteAdmin()) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Akses ditolak.');
        }
    ...
    private function storeArtikel()
    {
        $data = [
            ...
            'jenis_modul' => $this->request->getPost('jenis_modul') ?: null,
        ...
        return redirect()->to('/superadmin/layanan')->with('success', 'Artikel berhasil ditambahkan');
    }
    ...
    private function storeEvent($type)
    {
        ...
        return redirect()->to('/superadmin/layanan')->with('success', ucfirst($type) . ' berhasil ditambahkan');
    }
    ...
    private function storeTool($type)
    {
        ...
        return redirect()->to('/superadmin/layanan')->with('success', ($type === 'ea' ? 'Expert Advisor' : 'Toolkit') . ' berhasil ditambahkan');
    }
    ...
    private function storeSubscription($type)
    {
        ...
        return redirect()->to('/superadmin/layanan')->with('success', $this->getSubcategoryLabel($type) . ' berhasil ditambahkan');
    }
    ...
    public function edit($type, $id)
    {
        ...
        if (!$layanan) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Layanan tidak ditemukan');
        }
        ...
        return view('superadmin/layanan/edit', [
            'title' => 'Edit Layanan',
            'activeMenu' => 'layanan',
            'layanan' => $layanan,
            'layananType' => $type,
    ...
    private function updateArtikel($id)
    {
        ...
        if (!$artikel) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Artikel tidak ditemukan');
        }
        ...
        return redirect()->to('/superadmin/layanan')->with('success', 'Artikel berhasil diupdate');
    }
    ...
    private function updateEvent($type, $id)
    {
        ...
        if (!$event) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Event tidak ditemukan');
        }
        ...
        return redirect()->to('/superadmin/layanan')->with('success', ucfirst($type) . ' berhasil diupdate');
    }
    ...
    private function updateTool($type, $id)
    {
        ...
        if (!$tool) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Tool tidak ditemukan');
        }
        ...
        return redirect()->to('/superadmin/layanan')->with('success', ($type === 'ea' ? 'Expert Advisor' : 'Toolkit') . ' berhasil diupdate');
    }
    ...
    private function updateSubscription($type, $id)
    {
        ...
        if (!$sub) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Subscription tidak ditemukan');
        }
        ...
        return redirect()->to('/superadmin/layanan')->with('success', $this->getSubcategoryLabel($type) . ' berhasil diupdate');
    }
    ...
    public function delete($type, $id)
    {
        ...
        if (!$model) {
            return redirect()->to('/superadmin/layanan')->with('error', 'Type tidak valid');
        }
        ...
        $model->delete($id);
        return redirect()->to('/superadmin/layanan')->with('success', 'Layanan berhasil dihapus');
    }
    ...
    public function toggleStatus($type, $id)
    {
        ...
        return redirect()->to('/superadmin/layanan')->with('success', 'Status layanan berhasil diubah');
    }
}
