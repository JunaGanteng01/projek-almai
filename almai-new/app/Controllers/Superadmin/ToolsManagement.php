...
class ToolsManagement extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin/tools/index', [
    ...
    public function store()
    {
        ...
        return redirect()->to('/superadmin/tools')->with('success', 'Tools berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$tool) {
            return redirect()->to('/superadmin/tools')->with('error', 'Tools tidak ditemukan');
        }
        ...
        return view('superadmin/tools/edit', [
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/superadmin/tools')->with('success', 'Tools berhasil diupdate!');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/superadmin/tools')->with('success', 'Tools berhasil dihapus!');
    }
    ...
    public function toggleStatus($id)
    {
        ...
        return redirect()->to('/superadmin/tools')->with('success', 'Status tools berhasil diubah!');
    }
}
