...
class TeamManagement extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('superadmin/team/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('superadmin/team/create', $data);
    }
    ...
    public function store()
    {
        ...
        if ($this->teamModel->insert($data)) {
            return redirect()->to('/superadmin/tim')->with('success', 'Anggota tim berhasil ditambahkan');
        }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin/team/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        if ($this->teamModel->update($id, $data)) {
            return redirect()->to('/superadmin/tim')->with('success', 'Anggota tim berhasil diupdate');
        }
    ...
    public function delete($id)
    {
        ...
        if (!$team) {
            return redirect()->to('/superadmin/tim')->with('error', 'Anggota tim tidak ditemukan');
        }
        ...
        if ($this->teamModel->delete($id)) {
            return redirect()->to('/superadmin/tim')->with('success', 'Anggota tim berhasil dihapus');
        }

        return redirect()->to('/superadmin/tim')->with('error', 'Gagal menghapus anggota tim');
    }
}
