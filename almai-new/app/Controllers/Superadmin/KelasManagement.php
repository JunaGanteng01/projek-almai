...
class KelasManagement extends BaseController
{
    ...
    public function store()
    {
        ...
        return redirect()->to('/superadmin/kelas')->with('success', 'Kelas berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$kelas) {
            return redirect()->to('/superadmin/kelas')->with('error', 'Kelas tidak ditemukan');
        }
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/superadmin/kelas')->with('success', 'Kelas berhasil diupdate!');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/superadmin/kelas')->with('success', 'Kelas berhasil dihapus!');
    }
}
