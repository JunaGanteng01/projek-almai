...
class Merchandise extends BaseController
{
    public function index()
    {
        ...
        return view('superadmin/merchandise/index', [
    ...
    {
        return view('superadmin/merchandise/create', [
    ...
    public function store()
    {
        ...
        return redirect()->to('/superadmin/merchandise')->with('success', 'Merchandise berhasil ditambahkan');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$merchandise) {
            return redirect()->to('/superadmin/merchandise')->with('error', 'Merchandise tidak ditemukan');
        }

        return view('superadmin/merchandise/edit', [
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/superadmin/merchandise')->with('success', 'Merchandise berhasil diupdate');
    }
    ...
    public function delete($id)
    {
        ...
        $model->delete($id);
        return redirect()->to('/superadmin/merchandise')->with('success', 'Merchandise berhasil dihapus');
    }
    ...
    public function redemptions()
    {
        ...
        return view('superadmin/merchandise/redemptions', [
