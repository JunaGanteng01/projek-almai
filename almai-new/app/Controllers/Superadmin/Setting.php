...
class Setting extends BaseController
{
    ...
    public function update()
    {
        ...
        return redirect()->to('/superadmin/setting')->with('success', 'Settings berhasil disimpan!');
    }
    ...
    public function vouchers()
    {
        ...
        return view('superadmin/setting/vouchers', [
    ...
    public function saveVoucher()
    {
        ...
        return redirect()->to('/superadmin/setting/vouchers')->with('success', 'Voucher berhasil ditambahkan!');
    }
    ...
    public function deleteVoucher($code)
    {
        ...
        return redirect()->to('/superadmin/setting/vouchers')->with('success', 'Voucher berhasil dihapus!');
    }
    ...
    public function terms()
    {
        ...
        return view('superadmin/setting/terms', [
