...
class DaftarWpa extends BaseController
{
    public function index()
    {
        ...
        return view('user/daftar-wpa/index', [
            'title' => 'Daftar WPA - User Dashboard',
    ...
    public function detail($slug)
    {
        ...
        return view('user/daftar-wpa/detail', [
            'title' => $wpa['name'] . ' - User Dashboard',
            'activeMenu' => 'daftar-wpa',
            'wpa' => $wpa,
    ...
    public function layananDetail($slug)
    {
        ...
        // Search logic replicated from Cwpa\Layanan::detail
        $layananModel = new LayananModel();
        ...
        // We no longer redirect here so the user can view the page.
        // The advocacy prerequisite is now enforced via the UI (greyed out button).
        ...
        $packages = $priceModel
            ...
            ->where('layanan_type', $layanan['type'] ?? 'layanan')
            ->orderBy('price', 'ASC')
            ->findAll();
        ...
        return view('user/daftar-wpa/lihat-layanan', [
            'title' => $layanan['name'] . ' - User Dashboard',
            'layanan' => $layanan,
            'packages' => $packages,
            'reviews' => $reviews,
            ...
            'hasAdvokasi' => (function() use ($userId) {
    ...
    {
        // Advocacy is no longer a mandatory prerequisite for other services.
        // It is now handled via automatic bundling during the checkout process.
        return false;
    }
