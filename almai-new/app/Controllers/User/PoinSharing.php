...
class PoinSharing extends BaseController
{
    ...
    public function create()
    {
        ...
        if (empty($user['level_id']) || $user['level_id'] != \App\Models\LevelModel::LEVEL_PRO) {
            return redirect()->to('/user/poin')->with('error', 'Fitur Berbagi Poin hanya tersedia untuk Member PRO. Silakan upgrade akun Anda.');
        }
    ...
    public function store()
    {
        ...
        return redirect()->to('/user/poin/share')->with('success', 'Link berbagi poin berhasil dibuat!');
    }
