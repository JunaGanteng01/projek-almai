...
class ArtikelManagement extends BaseController
{
    ...
    public function approve($id)
    {
        ...
        return redirect()->to('/admin/artikel?filter=pending')->with('success', 'Artikel berhasil disetujui!');
    }
    ...
    public function reject($id)
    {
        ...
        return redirect()->to('/admin/artikel?filter=pending')->with('success', 'Artikel berhasil ditolak!');
    }
