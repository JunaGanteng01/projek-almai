...
class EventBannerManagement extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/event_banner/index', [
    ...
    {
        return view('admin/event_banner/create', [
    ...
    public function store()
    {
        ...
        return redirect()->to('/admin/event-banner')->with('success', 'Banner berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        if (!$banner) {
            return redirect()->to('/admin/event-banner')->with('error', 'Banner tidak ditemukan');
        }

        return view('admin/event_banner/edit', [
    ...
    public function update($id)
    {
        ...
        return redirect()->to('/admin/event-banner')->with('success', 'Banner berhasil diupdate!');
    }
    ...
    public function delete($id)
    {
        ...
        return redirect()->to('/admin/event-banner')->with('success', 'Banner berhasil dihapus!');
    }
}
