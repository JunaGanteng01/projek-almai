...
class Advokasi extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/layanan/pengaduan_index', [
    ...
    public function show($id)
    {
        ...
        if (!$complaint) {
            return redirect()->to('/admin/advokasi')->with('error', 'Data pengaduan tidak ditemukan.');
        }

        return view('admin/layanan/pengaduan_detail', [
    ...
    public function delete($id)
    {
        ...
        if ($complaint) {
            ...
            $model->delete($id);
            return redirect()->to('/admin/advokasi')->with('success', 'Data pengaduan berhasil dihapus.');
        }

        return redirect()->to('/admin/advokasi')->with('error', 'Data gagal dihapus.');
    }
    ...
    public function setting()
    {
        ...
        return view('admin/advokasi/setting', [
