...
class LegalDocuments extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('admin/legal_documents/index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin/legal_documents/create', $data);
    }
    ...
    public function store()
    {
        ...
        try {
            if ($this->legalDocumentModel->insert($data)) {
                return redirect()->to('/admin/legal-documents')->with('success', 'Dokumen berhasil ditambahkan');
            } else {
    ...
    public function edit($id)
    {
        ...
        if (!$document) {
            return redirect()->to('/admin/legal-documents')->with('error', 'Dokumen tidak ditemukan');
        }
        ...
        return view('admin/legal_documents/edit', $data);
    }
    ...
    public function update($id)
    {
        ...
        try {
            if ($this->legalDocumentModel->update($id, $data)) {
                return redirect()->to('/admin/legal-documents')->with('success', 'Dokumen berhasil diupdate');
            } else {
                return redirect()->back()->withInput()->with('errors', $this->legalDocumentModel->errors());
            }
        } catch (\Exception $e) {
    ...
    public function delete($id)
    {
        ...
        try {
            ...
            return redirect()->to('/admin/legal-documents')->with('success', 'Dokumen berhasil dihapus');
        } catch (\Exception $e) {
            log_message('error', 'Failed to delete legal document: ' . $e->getMessage());
            return redirect()->to('/admin/legal-documents')->with('error', 'Gagal menghapus dokumen: ' . $e->getMessage());
        }
    }
    ...
    public function preview($id)
    {
        ...
        return view('admin/legal_documents/preview', $data);
    }
