...
class Kyc extends BaseController
{
    ...
    public function detail($id)
    {
        ...
        if (!$user) {
            return redirect()->to('/admin/kyc')->with('error', 'User tidak ditemukan');
        }
    ...
    public function approve($id)
    {
        ...
        return redirect()->to('/admin/kyc')->with('success', $successMsg);
    }
    ...
    public function reject($id)
    {
        ...
        return redirect()->to('/admin/kyc')->with('success', 'KYC ditolak untuk user ' . $user['name']);
    }
}
