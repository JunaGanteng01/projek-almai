...
class Transaksi extends BaseController
{
    ...
    public function exportPdf()
    {
        ...
        return view('admin/transaksi/export-pdf', [
            'data' => $data,
    ...
    public function updateStatus($id)
    {
        if (!$this->canWriteAdmin()) {
            return redirect()->to('/admin/transaksi')->with('error', 'Akses ditolak.');
        }
        ...
        if ($newStatus === 'confirmed') {
            ...
            return redirect()->to('/admin/transaksi')->with('success', $successMsg);
        }

        return redirect()->to('/admin/transaksi')->with('success', 'Status transaksi berhasil diupdate!');
    }
    ...
    public function createManual()
    {
        ...
        return view('admin/transaksi/create_manual', [
    ...
    public function storeManual()
    {
        ...
        if ($xenditResponse['success']) {
            ...
            return redirect()->to('/admin/transaksi/detail/' . $transaksiId)->with('success', 'Transaksi manual berhasil dibuat. Link Pembayaran: <a href="'.$invoiceUrl.'" target="_blank" class="underline font-bold text-blue-500">'.$invoiceUrl.'</a>');
        } else {
            return redirect()->to('/admin/transaksi/detail/' . $transaksiId)->with('warning', 'Transaksi berhasil dibuat, namun gagal membuat link Xendit: ' . $xenditResponse['error']);
        }
    }
