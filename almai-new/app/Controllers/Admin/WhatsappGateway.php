...
class WhatsappGateway extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'api_url' => base_url('admin/whatsapp-gateway'),
            'templates' => $templateModel->findAll()
        ];

        return view('admin/whatsapp_gateway/index', $data);
    }
    ...
    public function templates()
    {
        ...
        return view('admin/whatsapp_gateway/templates', $data);
    }

    public function createTemplate()
    {
        $data = ['title' => 'Tambah Template WhatsApp'];
        return view('admin/whatsapp_gateway/create_template', $data);
    }
    ...
    public function storeTemplate()
    {
        ...
        if ($model->insert($data)) {
            return redirect()->to('/admin/whatsapp-gateway/templates')->with('success', 'Template berhasil disimpan.');
        }
    ...
    public function editTemplate($id)
    {
        ...
        if (!$template) return redirect()->to('/admin/whatsapp-gateway/templates')->with('error', 'Template tidak ditemukan.');
        $data = ['title' => 'Edit Template WhatsApp', 'template' => $template];
        return view('admin/whatsapp_gateway/edit_template', $data);
    }
    ...
    public function updateTemplate($id)
    {
        ...
        if ($model->update($id, $data)) {
            return redirect()->to('/admin/whatsapp-gateway/templates')->with('success', 'Template berhasil diperbarui.');
        }
    ...
    public function deleteTemplate($id)
    {
        $model = new \App\Models\WhatsappTemplateModel();
        if ($model->delete($id)) {
            return redirect()->to('/admin/whatsapp-gateway/templates')->with('success', 'Template berhasil dihapus.');
        }
        return redirect()->to('/admin/whatsapp-gateway/templates')->with('error', 'Gagal menghapus template.');
    }
}
